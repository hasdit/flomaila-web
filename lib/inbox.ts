...
const seed: Thread[] = [
  ...
  { id: "t2", name: "Omar", channel: "whatsapp", lastAt: new Date(Date.now() - 3600000).toISOString(), unread: false, messages: [{ id: "m2", at: new Date(Date.now() - 3600000).toISOString(), from: "customer", text: "Where is my order?" }, { id: "m3", at: new Date(Date.now() - 3500000).toISOString(), from: "ai", text: "I can look that up once an order id is on the thread." }] },
];
